...
class WeeklyOutOfService(models.Model):

    day_of_week = models.IntegerField(choices=WEEK_DAY_SET, default=0)

    def __str__(self):
        return "{}曜日運休".format(WEEK_DAYS[self.day_of_week])

    class Meta:
        verbose_name = "運休曜日"
        verbose_name_plural = "運休曜日リスト"
